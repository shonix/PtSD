...
(* Compile a complete micro-C program and write the resulting instruction
   list to file fname; also, return the program as a list of instructions.
 *)
