// macfacc.s - in Arm64 assembly for MacOS - shows how to call an assembly-defined
// recursive function fac from C code, and how to call C functions from assembly.
// sestoft@itu.dk * 2025-11-27
...
.main_loop:
    ...
    bl      _printi                     // Print result from x0
    mov     x0, 10                      
    bl      _printc                     // Print newline (ASCII 10) using printc
