...
//
// In this example the base class A is shared down the hierarchy,
// i.e., instance objects of class D shares same instance object of
// type A through the objects for classes B and C. This is achieved
