...
begin
  test (l01 10) 0;
  test l02 1;
  test (sumList (genList 5)) 15;
  test (sumList (append (genList 5) (genList 5))) 30;
  test (sumList (reverse (append (genList 5) (genList 5)))) 30;
  test (sumList (map (fn x -> 2*x) (reverse (append (genList 5) (genList 5))))) 60;
  test l04 true
end
