...
# Exercise 3
\* All diagram files can be found in the *image* folder if they do not show up in the `README.md` file as intended. 

## Exercise 3.2
The regular expression that can recognize all sequences described is:
